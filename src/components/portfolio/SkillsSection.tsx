  ...
  const skillCategories = [
    ...
    },
    {
      ...
      technologies: [
        ...
        { name: "REST APIs", color: "bg-indigo-500" },
      ]
    }
  ];
            ...
            >
              ...
              <div className="grid grid-cols-2 gap-3">
                {category.technologies.map((tech, techIndex) => (
                  ...
                  >
                    <div className={`w-10 h-10 rounded-lg ${tech.color} mx-auto mb-2 flex items-center justify-center group-hover/tech:scale-110 transition-transform`}>
